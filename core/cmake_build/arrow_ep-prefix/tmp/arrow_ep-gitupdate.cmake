...
execute_process(
  COMMAND "/usr/bin/git" show-ref apache-arrow-0.15.1
  WORKING_DIRECTORY "/home/czp/test/GIS/core/cmake_build/arrow/arrow"
...
if("${show_ref_output}" MATCHES "refs/remotes/apache-arrow-0.15.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "apache-arrow-0.15.1")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "apache-arrow-0.15.1")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 apache-arrow-0.15.1
  WORKING_DIRECTORY "/home/czp/test/GIS/core/cmake_build/arrow/arrow"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/apache/arrow.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/czp/test/GIS/core/cmake_build/arrow/arrow/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/czp/test/GIS/core/cmake_build/arrow/arrow/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
