...
# uncomment below if any config above is neccessary
set(ARROW_CMAKE_ARGS " -DARROW_BUILD_BENCHMARKS=OFF -DARROW_BUILD_TESTS=OFF -DARROW_PYTHON=ON")
...
configure_file("${CMAKE_SOURCE_DIR}/cmake/Arrow.CMakeLists.txt.cmake"
...
# install(
#     DIRECTORY   ${ARROW_ROOT}/install/include
#     DESTINATION ${CMAKE_BINARY_DIR}/thirdparty/include
# )

file(
    COPY                ${ARROW_ROOT}/install/include/arrow
    DESTINATION         ${CMAKE_BINARY_DIR}/thirdparty/include
)

file(
    COPY                ${ARROW_ROOT}/install/lib/
