...
std::vector<double> min_distacne(std::vector<std::string> roads, std::vector<std::string> gps_points) {
    ...
    for (int32_t i = 0; i < gps_points.size(); i++) {
        ...
        for (int32_t j = 0; j < roads.size(); j++) {
            ...
            auto err_code = OGRGeometryFactory::createFromWkt(roads[j].c_str(), nullptr, &road);
            if (err_code != OGRERR_NONE) throw nullptr;
...
TEST(MAP_MATCH_TEST, SNAP_TO_ROAD) {
    ...
    roads.push_back("LINESTRING (-73.9975944 40.7140611,-73.9976304 40.7140236,-73.9976714 40.7139869,-73.9977144 40.7139565,-73.9977556 40.7139321,-73.9978071 40.7139044,-73.9978556 40.7138806,-73.9980065 40.7138119,-73.9980743 40.7137811)");
    roads.push_back("LINESTRING (-73.9971597 40.7146482,-73.9973231 40.7144225,-73.9975206 40.7141496,-73.9975554 40.7141073,-73.9975944 40.7140611)");
    roads.push_back("LINESTRING (-73.9980379 40.7148267,-73.9981195 40.7145958,-73.9981237 40.7144379,-73.9980821 40.7144008,-73.9978864 40.714317,-73.997674 40.7140968,-73.9975944 40.7140611)");
    roads.push_back("LINESTRING (-73.997981 40.7136728,-73.9980743 40.7137811)");
    roads.push_back("LINESTRING (-73.9980743 40.7137811,-73.9984728 40.7136003,-73.9986438 40.7135233)");
    roads.push_back("LINESTRING (-73.9615014 40.7602517,-73.9614697 40.7602957,-73.9611014 40.7608112,-73.9610636 40.7608639)");
    roads.push_back("LINESTRING (-73.9615014 40.7602517,-73.961368 40.7601958,-73.9597732 40.7595203,-73.9594166 40.7593773,-73.9593736 40.7593593,-73.9592519 40.7593082)");
    roads.push_back("LINESTRING (-73.962885 40.7608321,-73.9624601 40.7606539,-73.9616496 40.7603139,-73.961609 40.7602969,-73.9615014 40.7602517)");
    roads.push_back("LINESTRING (-73.9619605 40.7596182,-73.9619023 40.7596941,-73.9615569 40.7601753,-73.9615014 40.7602517)");
    ...
    for (int32_t i = 0; i < compare_result.size(); i++) {
        ...
        assert((projection_point1->Distance(gps_point1) - compare_result[i]) <= esp);
    }
}