...
TEST(VEGA_WEIGHTED_POINT_MAP, JSON_CHECK_TEST) {
  // 1. invalid json test
  std::string str = " ";
  arctern::render::VegaWeightedPointmap vega1(str);
  assert(!vega1.is_valid());
  ...
  str =
      ...
      "  \"invalid_height\": 200\n"
      "}";
  arctern::render::VegaWeightedPointmap vega2(str);
  assert(!vega2.is_valid());
  ...
  str =
      ...
      "  \"invalid_marks\": -1\n"
      "}";
  arctern::render::VegaWeightedPointmap vega3(str);
  assert(!vega3.is_valid());

  // 4. invalid color ruler label test
  str =
      "{\n"
      "  \"width\": 300,\n"
      "  \"height\": 200,\n"
      ...
      "  ]\n"
      "}";
  arctern::render::VegaWeightedPointmap vega4(str);
  assert(!vega4.is_valid());

  // 5. invalid color ruler value test
  str =
      "{\n"
      "  \"width\": 300,\n"
      "  \"height\": 200,\n"
      ...
      "  ]\n"
      "}";
  arctern::render::VegaWeightedPointmap vega5(str);
  assert(!vega5.is_valid());
  ...
  str =
      ...
      "  ]\n"
      "}";
  arctern::render::VegaWeightedPointmap vega6(str);
  assert(!vega6.is_valid());
  ...
  str =
      ...
      "  ]\n"
      "}";
  arctern::render::VegaWeightedPointmap vega7(str);
  assert(!vega7.is_valid());

  // 8. invalid stroke ruler label test
  str =
      "{\n"
      "  \"width\": 300,\n"
      "  \"height\": 200,\n"
      ...
      "  ]\n"
      "}";
  arctern::render::VegaWeightedPointmap vega8(str);
  assert(!vega8.is_valid());

  // 9. invalid stroke ruler value test
  str =
      "{\n"
      "  \"width\": 300,\n"
      "  \"height\": 200,\n"
      ...
      "  ]\n"
      "}";
  arctern::render::VegaWeightedPointmap vega9(str);
  assert(!vega9.is_valid());
  ...
  str =
      ...
      "  ]\n"
      "}";
  arctern::render::VegaWeightedPointmap vega10(str);
  assert(!vega10.is_valid());
}
