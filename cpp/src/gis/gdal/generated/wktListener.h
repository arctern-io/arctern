...
class wktListener : public antlr4::tree::ParseTreeListener {
 public:
  ...
  virtual void enterCompoundCurveGeometry(
      wktParser::CompoundCurveGeometryContext* ctx) = 0;
  virtual void exitCompoundCurveGeometry(
      wktParser::CompoundCurveGeometryContext* ctx) = 0;
  ...
  virtual void enterMultiPolyhedralSurfaceGeometry(
      wktParser::MultiPolyhedralSurfaceGeometryContext* ctx) = 0;
  virtual void exitMultiPolyhedralSurfaceGeometry(
      wktParser::MultiPolyhedralSurfaceGeometryContext* ctx) = 0;

  virtual void enterMultiTinGeometry(wktParser::MultiTinGeometryContext* ctx) = 0;
  virtual void exitMultiTinGeometry(wktParser::MultiTinGeometryContext* ctx) = 0;
