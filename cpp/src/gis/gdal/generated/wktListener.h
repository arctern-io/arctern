...
public:
  ...
  virtual void enterMultiPolyhedralSurfaceGeometry(wktParser::MultiPolyhedralSurfaceGeometryContext *ctx) = 0;
  virtual void exitMultiPolyhedralSurfaceGeometry(wktParser::MultiPolyhedralSurfaceGeometryContext *ctx) = 0;
