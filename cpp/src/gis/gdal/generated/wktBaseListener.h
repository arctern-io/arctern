...
class wktBaseListener : public wktListener {
 public:
  ...
  void enterMultiCurveGeometry(wktParser::MultiCurveGeometryContext* /*ctx*/) override {}
  void exitMultiCurveGeometry(wktParser::MultiCurveGeometryContext* /*ctx*/) override {}

  void enterMultiSurfaceGeometry(
      wktParser::MultiSurfaceGeometryContext* /*ctx*/) override {}
  void exitMultiSurfaceGeometry(
      wktParser::MultiSurfaceGeometryContext* /*ctx*/) override {}

  void enterCurvePolygonGeometry(
      wktParser::CurvePolygonGeometryContext* /*ctx*/) override {}
  void exitCurvePolygonGeometry(
      wktParser::CurvePolygonGeometryContext* /*ctx*/) override {}

  void enterCompoundCurveGeometry(
      wktParser::CompoundCurveGeometryContext* /*ctx*/) override {}
  void exitCompoundCurveGeometry(
      wktParser::CompoundCurveGeometryContext* /*ctx*/) override {}
  ...
  void enterMultiPolyhedralSurfaceGeometry(
      wktParser::MultiPolyhedralSurfaceGeometryContext* /*ctx*/) override {}
  void exitMultiPolyhedralSurfaceGeometry(
      wktParser::MultiPolyhedralSurfaceGeometryContext* /*ctx*/) override {}

  void enterMultiTinGeometry(wktParser::MultiTinGeometryContext* /*ctx*/) override {}
  void exitMultiTinGeometry(wktParser::MultiTinGeometryContext* /*ctx*/) override {}
