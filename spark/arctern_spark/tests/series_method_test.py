...
def test_head(geo_s, pd_s):
    ...
    ret2 = pd_s.head(half)
    assert ret1.equals(GeoSeries(ret2)).all()
...
def test_reset_index(geo_s):
    count = geo_s.count()
    new_index = ["index_%d" % i for i in range(count)]
    geo_s = GeoSeries(geo_dropoff.to_list(), index=new_index)
    x = pd.Series(geo_dropoff.to_list(), index=new_index)
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.set_axis()` is not implemented yet.")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.tail()` is not implemented yet.")
...
def test_filter(geo_s, pd_s):
    ret1 = geo_s.filter(regex='0', axis=0)
    ret2 = pd_s.filter(regex='0', axis=0)
...
def test_isna(geo_s, pd_s):
    ret1 = geo_s.isna()
    ret2 = pd_s.isna()
    assert (ret1.to_pandas() == ret2).all()
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.interpolate()` is not implemented yet.")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.droplevel()` is not implemented yet.")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.asfreq()` is not implemented yet.")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.last_valid_index()` is not implemented yet.")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.resample()` is not implemented yet.")
def test_resample():
    index = pd.date_range('1/1/2000', periods=9, freq='T', tz='US/Central')
    geo_s = GeoSeries(geo_dropoff.to_list(), index=index)
    x = pd.Series(geo_dropoff.to_list(), index=index)
    pd_s = trans2wkb4series(x, x.index)
    geo_resample_s = geo_s.resample('1T').asfreq()
    pd_resamples_s = pd_s.resample('1T').asfreq()
    assert (geo_resample_s == GeoSeries(pd_resamples_s)).all()


# https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.tz_convert.html
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.tz_convert()` is not implemented yet.")
def test_tz_convert():
    index = pd.date_range('1/1/2000', periods=9, freq='T', tz='US/Central')
    geo_s = GeoSeries(geo_dropoff.to_list(), index=index)
    x = pd.Series(geo_dropoff.to_list(), index=index)
    ...
    assert (geo_tz_convert_s == GeoSeries(pd_tz_convert_s)).all()


# https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.tz_localize.html
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.tz_localize()` is not implemented yet.")
def test_tz_localize(geo_s, pd_s):
    ...
    assert (geo_tz_localize_s == GeoSeries(pd_tz_localize_s)).all()

    geo_tz_localize_s2 = geo_s.tz_localize('UTC', ambiguous='infer')
    pd_tz_localize_s2 = pd_s.tz_localize('UTC', ambiguous='infer')
    assert (geo_tz_localize_s2 == GeoSeries(pd_tz_localize_s2)).all()
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.between_time()` is not implemented yet.")
def test_between_time(geo_s, pd_s):
    ...
    assert (geo_between_time_s == GeoSeries(pd_betweem_time_s)).all()
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.slice_shift()` is not implemented yet.")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.argsort()` is not implemented yet.")
...
def test_sort_values(geo_s, pd_s):
    ...
    assert (geo_sort_values == GeoSeries(pd_sort_values)).all()
...
def test_sort_index(geo_s, pd_s):
    ...
    assert (geo_sort_index == GeoSeries(pd_sort_index)).all()


# https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.Series.swaplevel.html
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.swaplevel()` is not implemented yet.")
def test_swaplevel():
    ...
    assert (geo_swaplevel == GeoSeries(pd_swaplevel)).all()
...
@pytest.mark.skip("AttributeError: 'Series' object has no attribute 'explode'")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.searchsorted()` is not implemented yet.")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.ravel()` is not implemented. If you want to collect your flattened underlying data as an NumPy array, use 'to_numpy().ravel()' instead.")
...
def test_repeat(geo_s, pd_s):
    ...
    assert (geo_repeat == GeoSeries(pd_repeat)).all()
...
def test_squeeze(geo_s, pd_s):
    ...
    assert (geo_squeeze == GeoSeries(pd_squeeze)).all()
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.__iter__()` is not implemented. If you want to collect your data as an NumPy array, use 'to_numpy()' instead.")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The property `pd.Series.array()` is not implemented.")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The property `pd.Series.nbytes()` is not implemented.")
...
@pytest.mark.skip("AttributeError: 'Series' object has no attribute 'convert_dtypes'")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.infer_objects()` is not implemented yet.")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.to_period()` is not implemented yet.")
def test_to_period():
    index = pd.date_range('1/1/2000', periods=geo_dropoff.count(), freq='T')
    print(geo_dropoff.count())
    geo_s = GeoSeries(geo_dropoff.to_list(), index=index)
    x = pd.Series(geo_dropoff.to_list(), index=index)
    pd_s = trans2wkb4series(x, x.index)
...
@pytest.mark.skip("AttributeError: __array__")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.items()` is not implemented yet.")
...
@pytest.mark.skip("databricks.koalas.exceptions.PandasNotImplementedError: The method `pd.Series.iteritems()` is not implemented yet.")
...
@pytest.mark.skip("koalas key not equal pandas key")
