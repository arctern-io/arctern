...
def heatmap(df, vega):
    ...
    first_agg_df = df.mapInPandas(render_agg_UDF)
    first_res = first_agg_df.coalesce(1)
    final_agg_df = first_res.mapInPandas(render_agg_UDF)
    final_agg_df = final_agg_df.coalesce(1)
