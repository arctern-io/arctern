...
def test_ST_GeomFromGeoJSON():
    ...
    str_ptr = arctern.ST_GeomFromGeoJSON(data)
...
def test_ST_ConvexHull():
    ...
    data = pandas.Series(data)
    rst = arctern.ST_ConvexHull(data)
...
def test_ST_Buffer():
    ...
    data = pandas.Series(data)
    rst = arctern.ST_Buffer(data, 1.2)
...
def test_ST_Union_Aggr():
    ...
    rst = arctern.ST_Union_Aggr(data)
    assert rst == "POLYGON ((1 1,1 2,2 2,3 2,3 1,2 1,1 1))"
    ...
    data = pandas.Series([p1, p2])
    rst = arctern.ST_Union_Aggr(data)
    assert rst == "POLYGON ((4 1,4 0,0 0,0 4,4 4,4 2,5 2,5 1,4 1))"
    ...
    data = pandas.Series([p1, p2])
    rst = arctern.ST_Union_Aggr(data)
    assert rst == "MULTIPOLYGON (((0 0,4 0,4 4,0 4,0 0)),((5 1,7 1,7 2,5 2,5 1)))"
...
def test_ST_Envelope_Aggr():
    ...
    p2 = "POLYGON ((5 1,7 1,7 2,5 2,5 1))"
    data = pandas.Series([p1, p2])
    rst = arctern.ST_Envelope_Aggr(data)
    assert rst == "POLYGON ((0 0,0 4,7 4,7 0,0 0))"
