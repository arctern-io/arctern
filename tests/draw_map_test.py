...
def run_test_point_map(spark):
    ...
    assert run_diff_png(baseline_png1, png_path + "test_point_map_nyc_1-1.png", 0.1)
    assert run_diff_png(baseline_png1, png_path + "test_point_map_nyc_1-2.png", 0.1)
    assert run_diff_png(baseline_png2, png_path + "test_point_map_nyc_2-1.png", 0.1)
    assert run_diff_png(baseline_png2, png_path + "test_point_map_nyc_2-2.png", 0.1)
    assert run_diff_png(baseline_png3, png_path + "test_point_map_nyc_3-1.png", 0.1)
    assert run_diff_png(baseline_png3, png_path + "test_point_map_nyc_3-2.png", 0.1)
    assert run_diff_png(baseline_png4, png_path + "test_point_map_nyc_4-1.png", 0.1)
    assert run_diff_png(baseline_png4, png_path + "test_point_map_nyc_4-2.png", 0.1)
    assert run_diff_png(baseline_png5, png_path + "test_point_map_nyc_5-1.png", 0.1)
    assert run_diff_png(baseline_png5, png_path + "test_point_map_nyc_5-2.png", 0.1)
    assert run_diff_png(baseline_png6, png_path + "test_point_map_nyc_6-1.png", 0.15)
    assert run_diff_png(baseline_png6, png_path + "test_point_map_nyc_6-2.png", 0.15)
...
def run_test_weighted_point_map(spark):
    ...
    assert run_diff_png(baseline_png1_1, png_path + "test_weighted_point_map_nyc_1_1-1.png", 0.1)
    assert run_diff_png(baseline_png1_1, png_path + "test_weighted_point_map_nyc_1_1-2.png", 0.1)
    assert run_diff_png(baseline_png1_2, png_path + "test_weighted_point_map_nyc_1_2-1.png", 0.1)
    assert run_diff_png(baseline_png1_2, png_path + "test_weighted_point_map_nyc_1_2-2.png", 0.1)
    assert run_diff_png(baseline_png1_3, png_path + "test_weighted_point_map_nyc_1_3-1.png", 0.1)
    assert run_diff_png(baseline_png1_3, png_path + "test_weighted_point_map_nyc_1_3-2.png", 0.1)
    assert run_diff_png(baseline_png1_4, png_path + "test_weighted_point_map_nyc_1_4-1.png", 0.1)
    assert run_diff_png(baseline_png1_4, png_path + "test_weighted_point_map_nyc_1_4-2.png", 0.1)
    assert run_diff_png(baseline_png1_5, png_path + "test_weighted_point_map_nyc_1_5-1.png", 0.1)
    assert run_diff_png(baseline_png1_5, png_path + "test_weighted_point_map_nyc_1_5-2.png", 0.1)
    assert run_diff_png(baseline_png2_1, png_path + "test_weighted_point_map_nyc_2_1-1.png", 0.1)
    assert run_diff_png(baseline_png2_1, png_path + "test_weighted_point_map_nyc_2_1-2.png", 0.1)
    assert run_diff_png(baseline_png2_2, png_path + "test_weighted_point_map_nyc_2_2-1.png", 0.1)
    assert run_diff_png(baseline_png2_2, png_path + "test_weighted_point_map_nyc_2_2-2.png", 0.1)
    assert run_diff_png(baseline_png2_3, png_path + "test_weighted_point_map_nyc_2_3-1.png", 0.1)
    assert run_diff_png(baseline_png2_3, png_path + "test_weighted_point_map_nyc_2_3-2.png", 0.1)
    assert run_diff_png(baseline_png2_4, png_path + "test_weighted_point_map_nyc_2_4-1.png", 0.1)
    assert run_diff_png(baseline_png2_4, png_path + "test_weighted_point_map_nyc_2_4-2.png", 0.1)
    assert run_diff_png(baseline_png2_5, png_path + "test_weighted_point_map_nyc_2_5-1.png", 0.1)
    assert run_diff_png(baseline_png2_5, png_path + "test_weighted_point_map_nyc_2_5-2.png", 0.1)
    assert run_diff_png(baseline_png3_1, png_path + "test_weighted_point_map_nyc_3_1-1.png", 0.1)
    assert run_diff_png(baseline_png3_1, png_path + "test_weighted_point_map_nyc_3_1-2.png", 0.1)
    assert run_diff_png(baseline_png3_2, png_path + "test_weighted_point_map_nyc_3_2-1.png", 0.1)
    assert run_diff_png(baseline_png3_2, png_path + "test_weighted_point_map_nyc_3_2-2.png", 0.1)
    assert run_diff_png(baseline_png3_3, png_path + "test_weighted_point_map_nyc_3_3-1.png", 0.1)
    assert run_diff_png(baseline_png3_3, png_path + "test_weighted_point_map_nyc_3_3-2.png", 0.1)
    assert run_diff_png(baseline_png3_4, png_path + "test_weighted_point_map_nyc_3_4-1.png", 0.1)
    assert run_diff_png(baseline_png3_4, png_path + "test_weighted_point_map_nyc_3_4-2.png", 0.1)
    assert run_diff_png(baseline_png3_5, png_path + "test_weighted_point_map_nyc_3_5-1.png", 0.1)
    assert run_diff_png(baseline_png3_5, png_path + "test_weighted_point_map_nyc_3_5-2.png", 0.1)
    assert run_diff_png(baseline_png4_1, png_path + "test_weighted_point_map_nyc_4_1-1.png", 0.1)
    assert run_diff_png(baseline_png4_1, png_path + "test_weighted_point_map_nyc_4_1-2.png", 0.1)
    assert run_diff_png(baseline_png4_2, png_path + "test_weighted_point_map_nyc_4_2-1.png", 0.1)
    assert run_diff_png(baseline_png4_2, png_path + "test_weighted_point_map_nyc_4_2-2.png", 0.1)
    assert run_diff_png(baseline_png4_3, png_path + "test_weighted_point_map_nyc_4_3-1.png", 0.1)
    assert run_diff_png(baseline_png4_3, png_path + "test_weighted_point_map_nyc_4_3-2.png", 0.1)
    assert run_diff_png(baseline_png4_4, png_path + "test_weighted_point_map_nyc_4_4-1.png", 0.1)
    assert run_diff_png(baseline_png4_4, png_path + "test_weighted_point_map_nyc_4_4-2.png", 0.1)
    assert run_diff_png(baseline_png4_5, png_path + "test_weighted_point_map_nyc_4_5-1.png", 0.1)
    assert run_diff_png(baseline_png4_5, png_path + "test_weighted_point_map_nyc_4_5-2.png", 0.1)
...
def run_test_heat_map(spark):
    ...
    assert run_diff_png(baseline_png1, png_path + "test_heat_map_nyc_1-1.png", 0.2)
    assert run_diff_png(baseline_png1, png_path + "test_heat_map_nyc_1-2.png", 0.2)
    assert run_diff_png(baseline_png2, png_path + "test_heat_map_nyc_2-1.png", 0.2)
    assert run_diff_png(baseline_png2, png_path + "test_heat_map_nyc_2-2.png", 0.2)
    assert run_diff_png(baseline_png3, png_path + "test_heat_map_nyc_3-1.png", 0.2)
    assert run_diff_png(baseline_png3, png_path + "test_heat_map_nyc_3-2.png", 0.2)
    assert run_diff_png(baseline_png4, png_path + "test_heat_map_nyc_4-1.png", 0.2)
    assert run_diff_png(baseline_png4, png_path + "test_heat_map_nyc_4-2.png", 0.2)
    assert run_diff_png(baseline_png5, png_path + "test_heat_map_nyc_5-1.png", 0.25)
    assert run_diff_png(baseline_png5, png_path + "test_heat_map_nyc_5-2.png", 0.25)
...
def run_test_icon_viz(spark):
    ...
    assert run_diff_png(baseline_png3, png_path + "test_icon_viz_nyc_3-1.png", 0.1)
    assert run_diff_png(baseline_png3, png_path + "test_icon_viz_nyc_3-2.png", 0.1)
