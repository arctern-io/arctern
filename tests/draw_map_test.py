...
def run_diff_png(baseline_png, compared_png, precision=0.2):
...
def run_test_heat_map(spark):
    ...
    assert run_diff_png(baseline_png1, png_path + "test_heat_map_nyc_1-1.png")
    assert run_diff_png(baseline_png1, png_path + "test_heat_map_nyc_1-2.png")
    assert run_diff_png(baseline_png2, png_path + "test_heat_map_nyc_2-1.png")
    assert run_diff_png(baseline_png2, png_path + "test_heat_map_nyc_2-2.png")
    assert run_diff_png(baseline_png3, png_path + "test_heat_map_nyc_3-1.png")
    assert run_diff_png(baseline_png3, png_path + "test_heat_map_nyc_3-2.png")
    assert run_diff_png(baseline_png4, png_path + "test_heat_map_nyc_4-1.png")
    assert run_diff_png(baseline_png4, png_path + "test_heat_map_nyc_4-2.png")
...
def run_test_icon_viz(spark):
    ...
    assert run_diff_png(baseline_png3, png_path + "test_icon_viz_nyc_3-1.png")
...
def run_test_fishnet_map(spark):
    ...
    assert run_diff_png(baseline_png1, png_path + "test_fishnet_map_nyc_1-1.png")
    assert run_diff_png(baseline_png1, png_path + "test_fishnet_map_nyc_1-2.png")
    assert run_diff_png(baseline_png2, png_path + "test_fishnet_map_nyc_2-1.png")
    assert run_diff_png(baseline_png2, png_path + "test_fishnet_map_nyc_2-2.png")
    assert run_diff_png(baseline_png3, png_path + "test_fishnet_map_nyc_3-1.png")
    assert run_diff_png(baseline_png3, png_path + "test_fishnet_map_nyc_3-2.png")
    assert run_diff_png(baseline_png4, png_path + "test_fishnet_map_nyc_4-1.png")
    assert run_diff_png(baseline_png4, png_path + "test_fishnet_map_nyc_4-2.png")
    assert run_diff_png(baseline_png5, png_path + "test_fishnet_map_nyc_5-1.png")
    assert run_diff_png(baseline_png5, png_path + "test_fishnet_map_nyc_5-2.png")
